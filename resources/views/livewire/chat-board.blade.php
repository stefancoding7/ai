                    ...
                    <div class="col-8">
                        <div class="row">
                            ...
                            @if(auth()->user()->gpt_4)
                                <div class="col-4 m-0 p-0">
                                    <div class="d-grid gap-2">
                                        <button wire:click="setSelected_gpt('gpt-4o-2024-05-13')" class="btn btn-{{$selected_gpt != 'gpt-4o-2024-05-13' ? 'outline-' : ''}}info" style="border-radius: 20px; font-size: 12px; {{$selected_gpt != 'gpt-4o-2024-05-13' ? 'color: black;' : ''}}">GPT 4o</button>
                                    </div>
